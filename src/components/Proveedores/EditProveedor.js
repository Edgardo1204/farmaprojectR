    ...
    return (
        <div className="container mt-5" style={{ backgroundColor: '#E9ECEF' }}>
            <div className="d-grid gap-2">
                <Link to="/proveedores" className="btn btn-success btn-sm position-absolute top-0 end-0 m-2" style={{ backgroundColor: '#f6a8c9', borderColor: '#f6a8c9' }}>Volver</Link>
            </div>
            <div className="row justify-content-center">
                <div className="col-md-6">
                    <div className="card" style={{ backgroundColor: '#D1D8E0' }}>
                        <div className="card-body">
                            <h3 className="card-title text-center mb-4" style={{ color: '#6610f2' }}>Editar proveedor</h3>
                            <form onSubmit={update}>
                                ...
                                <div className="mb-3">
                                    <label className="form-label">No. Telefonico</label>
                                    <input
                                        value={telefono}
